...
class Vip extends CI_Controller {
    ...
    function get_pdf($uid = 0, $limit = 0) {
        ...
        $this->kirim_email_reservasi_vip($pdf['id_booking']);
        //debug_data($pdf);
    ...
    function kirim_email_reservasi_vip($uid) {
        $sql = "select
                a.email as member, 
                e.email as vip,
                c.time_sch,
        ...
        kirim_kirim_email($email, 'Reservation information', "Thank you for making reservation for vip, your departure at ".$e['time_sch']);
        $email2 = array($e['vip']);

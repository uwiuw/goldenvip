    ...
    <div id="hotel-detail">
        ...
        <div id="detail-hotel">
            ...
            <div class="box-detail-hotel">
                <div class="tx-rwadminhotelmlm-pi1">Congratulations <strong><?php echo $sponsor['username']; ?></strong>, you has been registered <strong><?php echo $downline['username']; ?> with <?php echo $msg; ?></strong></div>

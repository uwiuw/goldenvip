                            ...
                            <table cellspacing="1" cellpadding="0" border="0" id="tablesorter" class="tablesorter">
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td><strong><?php $p = $this->Mix->read_row_ret_field_by_value('tx_rwmembermlm_package', 'package', $mreq['package'], 'uid');
                        echo $p['package'];
                        ?></strong>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <strong><?php echo $mreq['email']; ?></strong>
                                            <input type="hidden" name="email" value='<?php echo $mreq['email']; ?>'>
                                        </td>
                                    </tr>
                                    <tr class="even">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td><strong><?php $c = $this->Mix->read_row_ret_field_by_value('tx_rwmembermlm_phonecountrycode', 'country', $mreq['country'], 'uid');
                                                echo $c['country'];
                        ?></strong></td>
                                    </tr>
                                    <tr class="even">
                                    ...
                                    <tr class="even" id="disp_province">
                                        ...
                                        <td id="disp_option1"><strong><?php $pr = $this->Mix->read_row_ret_field_by_value('tx_rwmembermlm_province', 'province', $mreq['province'], 'uid');
                                                echo $pr['province'];
                        ?></strong></td>
                                    </tr>
                                    <tr class="odd" id="disp_city">
                                        <td width="200px"><strong>City</strong></td>
                                        <td><strong><?php $ct = $this->Mix->read_row_ret_field_by_value('tx_rwmembermlm_city', 'city', $mreq['city'], 'uid');
                                                echo $ct['city'];
                        ?></strong></td>
                                    </tr>
                                    <tr class="even">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td><strong><?php $rg = $this->Mix->read_row_ret_field_by_value('tx_rwmembermlm_city', 'city', $mreq['regional'], 'uid');
                                                echo $rg['city'];
                        ?></strong></td>
                                    </tr>
                                    <tr class="even">

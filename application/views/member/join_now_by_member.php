...
<script type="text/javascript">
    ...
    function select_package()
    {
        ...
        else
        {
            jQuery('#display_sel_pck2').hide();
            jQuery('#join_payment').hide();
            jQuery('#payment_member').val('cash');
        }
    }
	
    function select_package2()
    {
        if(jQuery('#package2').val() == '4'){
            jQuery('#join_payment').show();
        }else{
            jQuery('#join_payment').hide();
            jQuery('#payment_member').val('cash');
        }
            ...
            <div class="tx-rwmembermlm-pi1">
                ...
                <form class="et-form"  method="post" id="form-photo" name="form-photo" autocomplete="off" action="<?php echo site_url('member/join-now-by-member'); ?>"><input type="hidden" name="usercategory" id="usercategory" value="4" />
                    ...
                    <div id="join_payment">
                        ...
                        <select name="payment_member" id="payment_member">
                            <option value="cash" selected="selected">Cash</option>
                            <option value="redeem">Redeem Point</option>
                        </select>
                        <label id="block_join_payment"></label>
                        <label id="error_join_payment"></label>
                        <div class="clr"></div>
                    </div>

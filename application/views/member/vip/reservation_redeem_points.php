...
<script type="text/javascript">
	...
	function check()
	{
		if(document.getElementById('packagevip').value == '')
		{
...
<div class="container">
	<div id="box-reservation">
		<div id="reservation-top">
			<div id="home-top"><h2>Reservation With Redeem Points <?php echo $selected; ?></h2></div>
		</div>
		<div id="reservation">
		<div id="left">
				...
				<div class="tx-rwadminhotelmlm-pi1">
					<div id="find">
                        ...
                        <form method="POST" action="<?php echo site_url('member/reservation/vip/package-selected');?>" class="et-form" name="reservasi" enctype="multipart/form-data"> 
                    		...
                    		<div>
                                <label class="desc">Time Schedule :
                            ...
                            <div id="payment">
                                ...
                                <input type="text" value="Reservation with redeem points" name="select_payment" id="select_payment" readonly="readonly" >
                                <div class="clr"></div>
                            </div>

								...
								<div id="List">
									<div class="overview">
                                        ...
                                        <?php
											...
											{
										?>
                                        	<form id="book<?php echo $row['uid']; ?>" method="POST" action="<?php echo site_url('member/reservation/vip/use-this-reservation-for'); ?>">
														...
														<tr>
															...
															<td class="maxPeople">
                                                            	<select id="jumlah_book<?php echo $row['uid']; ?>" name="qty" class="qty">
																	...
																	<?php } } else { echo "<option value='1'>1</option>";} ?>
                                                                </select>
                                                            </td>

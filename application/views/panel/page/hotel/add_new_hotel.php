...
<form name="add_new_data_hotel">
    <table>
        ...
        <tr>
            <td>Destination</td>
            <td><?php $id = "id='destination' onchange='management_hotel_cek_detail();' ";
echo form_dropdown('destination', $destination, '', $id); ?></td>
            <td id="error_destination"></td>
        </tr>
        <tr>
            <td>Destination Detail</td>
            <td id="destination_detail"><?php if (isset($destination_detail)): echo form_dropdown('destination_detail', $destination_detail);
                endif; ?></td>
            <td></td>
        </tr>
        <tr>
            <td>Star</td>
            <td><?php $id = "id='star'";
                echo form_dropdown('star', $star, '', $id); ?></td>
            <td id="error_star"></td>
        </tr>
        <tr>
            <td>Compliment</td>
            <td><?php $id = "id = 'compliment'";
                echo form_dropdown('compliment', $compliment, '', $id); ?></td>
            <td id="error_compliment"></td>
        </tr>
        <tr>
            <td>Management by core</td>
            <td><?php $id = "id='core'";
                echo form_dropdown('management_by', $by_core, '', $id); ?></td>
            <td id="error_core"></td>
        </tr>
        <tr>
            <td colspan="2" align="right"><input type="button" class="button" value="Save" onclick="management_hotel_cek_form('blank');"/></td>
        </tr>
    </table>
</form>
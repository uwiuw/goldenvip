        ...
        <tbody id="result-show-search-url">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" value="<?php $string = trim($page['homephone'], $code[$page['country']] . "-");
                    echo $string; ?>" id="homephone" name="homephone"></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="countrycode" name="contrycode" value="<?php echo $code[$page['country']]; ?>" readonly="readonly" size="4" />
                    <input type="text" value="<?php $string = trim($page['mobilephone'], $code[$page['country']] . "-");
                           echo $string; ?>" name="mobilephone">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td id="block_regional">
                    <?php
                    $id = "id='regional'";
                    echo form_dropdown('regional', $city, $page['regional'], $id);
                    ?>
                </td>
            </tr>
